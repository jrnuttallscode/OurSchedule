...
namespace OurSchedule.Controllers
{
    public class AvailabilitiesController : Controller
    {
        ...
        public AvailabilitiesController(ScheduleContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Availability != null ? 
                          View(await _context.Availability.ToListAsync()) :
                          Problem("Entity set 'ScheduleContext.Availability'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,User_Role,Shift_Id,Department,Location")] Availability availability)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,User_Role,Shift_Id,Department,Location")] Availability availability)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'OurScheduleContext.Availability'  is null.");
            }
            var availability = await _context.Availability.FindAsync(id);
            if (availability != null)
            {
        ...
        {
          return (_context.Availability?.Any(e => e.Id == id)).GetValueOrDefault();
        }
    }
}
